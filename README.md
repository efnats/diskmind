...
SMART disk health monitoring for Linux servers. Zero dependencies, just Python.
...
Open `http://localhost:8080` → Add hosts via Settings → Done.

## What Makes It Different

- **Zero dependencies** — Python 3.8+ standard library only. No pip, no Docker, no hassle.
- **SSH or Push** — Pull data via SSH, or let agents push through firewalls. Mix both.
- **Smart alerting** — Delta-based detection. Old issues don't spam you, new ones do.
